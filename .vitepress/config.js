...
export default {
    ...
    head: [
      ...
      })(window,document,'script','dataLayer','GTM-K88Z3FK');`],
...
function get202210TIL(){
  return {
    ...
    items: [
      ...
      {text: '2022/10/05', link: '/TIL/202210/20221005'},
      {text: '2022/10/06', link: '/TIL/202210/20221006'},
      {text: '2022/10/07', link: '/TIL/202210/20221007'},
      {text: '2022/10/08', link: '/TIL/202210/20221008'},
      {text: '2022/10/09', link: '/TIL/202210/20221009'},
      {text: '2022/10/10', link: '/TIL/202210/20221010'},
      {text: '2022/10/11', link: '/TIL/202210/20221011'},
      {text: '2022/10/12', link: '/TIL/202210/20221012'},
      {text: '2022/10/13', link: '/TIL/202210/20221013'},
      {text: '2022/10/14', link: '/TIL/202210/20221014'},
      {text: '2022/10/15', link: '/TIL/202210/20221015'},
      {text: '2022/10/16', link: '/TIL/202210/20221016'},
      {text: '2022/10/17', link: '/TIL/202210/20221017'},
      {text: '2022/10/18', link: '/TIL/202210/20221018'},
      {text: '2022/10/19', link: '/TIL/202210/20221019'},
      {text: '2022/10/20', link: '/TIL/202210/20221020'},
      {text: '2022/10/21', link: '/TIL/202210/20221021'},
      {text: '2022/10/22', link: '/TIL/202210/20221022'},
      {text: '2022/10/23', link: '/TIL/202210/20221023'},
      {text: '2022/10/24', link: '/TIL/202210/20221024'},
      {text: '2022/10/25', link: '/TIL/202210/20221025'},
...
function get202211TIL(){
  return {
    ...
    items: [
      ...
      {text: '2022/11/07', link: '/TIL/202211/20221107'},
      {text: '2022/11/08', link: '/TIL/202211/20221108'},
      {text: '2022/11/09', link: '/TIL/202211/20221109'},
      {text: '2022/11/10', link: '/TIL/202211/20221110'},
      {text: '2022/11/11', link: '/TIL/202211/20221111'},
      {text: '2022/11/12', link: '/TIL/202211/20221112'},
      {text: '2022/11/13', link: '/TIL/202211/20221113'},
      {text: '2022/11/14', link: '/TIL/202211/20221114'},
